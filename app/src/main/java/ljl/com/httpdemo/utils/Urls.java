package ljl.com.httpdemo.utils;
...
public class Urls {
    ...
    //http://192.168.1.114:8810 IHGOO
    public static final String IQG_URL="http://192.168.1.114:8810";
    public static final String IQG_URL_REGISTER=IQG_URL+"/mobile/login";

   //czaccout
    public static final String IQG_URL2="http://192.168.1.08:8810";
    public static final String IQG_URL_REGISTER2=IQG_URL2+"/czaccout";
